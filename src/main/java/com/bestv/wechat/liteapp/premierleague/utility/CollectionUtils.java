...
public abstract class CollectionUtils {
	 ...
	 */
	public static boolean containsAny(Collection<Object> source, Collection<Object> candidates) {
	 ...
	 */
	public static boolean hasUniqueObject(Collection<Object> collection) {
		if (isEmpty(collection)) {
			return false;
		}

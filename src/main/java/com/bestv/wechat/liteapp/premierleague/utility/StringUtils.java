...
public abstract class StringUtils {
    ...
    public static boolean hasText(CharSequence str) {
        if (!hasLength(str) || "null".equals(str)) {
            return false;
        }
    ...
    public static boolean hasText(Object object) {
        ...
        return hasText((CharSequence) object.toString());
    }
    ...
    public static String[] subArray(String[] arr1, String[] arr2) {
     ...
     */
    public static String zipAndEncode(String encodestr)
            throws DataFormatException {
    ...
    public static String decodeAndUnzip(String e) throws DataFormatException {
    ...
    public static void main(String[] arg) throws DataFormatException {//1592639
        //String msg = "eJyrVipOTXbOT0lVslIK9nWP93GPd4lU0lEqyS9JzPErzVWyMgRyMktyQAqeTV/wZNeupz27gAryoHJA7SFlnilA2dK8lNS0zLzUFJB2iJChqYWpgbkhWABqCVDIzNjYCChUWpxaBFZlmWJiaG5hYqJrYWiepmtomGqsm2RsmqxrkmZumpyYkmxibmSpVAsAh+QzzA==";
        //String msg = "eJyrVipOTXbOT0lVslIK9nWPNzQwMDJW0lEqyS9JzPErzVWyMgRyMktyQAqedrQ96+x+OqHj+a5lQDV5UGmgCSFlnilABYYGJqbGlgYg/VABU0tDYwOwgWVQW4BCRmbGlkCh0uLUIrAqyxQTQ3MLExNdC0PzNF1Dw1Rj3SRj02RdkzRz0+TElGQTcyNLpVoAFOoyeg==";

        String msg = "eJyrVkrOzytJzStxzk9JVbJSMjS1tDQ2tlTSUSrJLMkBibyc1f10yoQX3Rtfzm4xBoonJ5akpucXVXqWpOZ6poC0GJhYWphaAKVSCzKLgcb4leYmpRYpWRnrKOWXlDhD1UMtCPZ1j/cPCYkPCYsPclKqBQB8eyyP";
        String json = StringUtils.decodeAndUnzip(msg);
        ...
        System.out.println("89342.99092034".replaceAll("\\.\\d*", ""));
        //System.out.println(URLEncoder.encode("李佳💓💓 ","UTF-8"));
        //System.out.println(URLDecoder.decode("%E8%90%A7%E6%B1%B6%E5%A8%81+umi","UTF-8"));
        System.out.println("搜索|捜索法dw".replaceAll("(^\\s*搜索\\s*|\\s*捜索\\s*)", ""));

        Map<String, Object> testMap = null;
        try {
            testMap = JSONUtil.convertObject("{ \"subscribe\": 0, \"openid\": \"o6_bmjrPTlm6_2sgVt7hMZOPfL2M\",  \"nickname\": \"Band\"}");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        System.out.println(testMap.get("subscribe").getClass().getName() + "subscribe " + testMap.get("subscribe"));
        System.out.println((Double) testMap.get("subscribe") == 0);
    }
